       ...
       className="fixed top-0 left-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-zinc-200">
        <div className='max-w-7xl mx-auto px-16 h-16 flex items-center justify-between'>
          ...
          {email? <div className="relative" ref={popupRef}>
            ...
            flex items-center justify-center font-semibold hover:scale-105 transition"
      ...
      <section className="pt-36 pb-28 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            >AI Customer Support Built for Modern Websites
            </h1>
            <p className="mt-6 text-lg text-zinc-600 max-w-xl">
              Add a powerful AI chatbot to your website in minutes.
              Let your customers get instant answers using own business knowledge.
            </p>
            <div className="mt-10 flex gap-5">

              {email ? <button className="px-7 py-3 bg-black text-white
              font-medium hover:bg-zinc-800 rounded-xl transition
              disabled:opacity-60" onClick={()=>navigate.push('/dashboard')}
              >Go to Dashboard</button> : <button className="px-7 py-3 bg-black text-white
              font-medium hover:bg-zinc-800 rounded-xl transition
              disabled:opacity-60"
              onClick={handleLogin}
              >Get Started</button>}
          ...
          >
           <div className="rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
                ...
                <div className="space-y-3">
                   ...
                   <div className="bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit">Yes, Cash On Deliery is available.</div>
                </div>
           <motion.div
           animate={{ y: [0, -12, 0]}}
      ...
      className="bg-zinc-50 py-28 px-6 border-t border-zinc-200">
        <div className="max-w-6xl mx-auto">
          ...
          className="text-3xl font-semibold text-center">
            Why Businesses Choose SuportAI
          </motion.h2>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-3">
            {features.map((f, index) => (
              ...
              >
                <h1 className="textl-g font-medium">{f.title}</h1>
