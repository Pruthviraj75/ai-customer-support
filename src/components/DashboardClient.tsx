      ...
      transition={{duration:0.5}}
       className="fixed top-0 left-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-zinc-200">
        <div className='max-w-7xl mx-auto px-16 h-16 flex items-center justify-between'>
          ...
          className='text-lg cursor-pointer font-semibold tracking-tight'>Support <span className='text-zinc-400'>AI</span>
          </div>
          <button 
         ...
         >
          ...
          <div className='mb-10'>
            ...
            <div className='space-y-4'>
                 ...
                 focus:outline-none focus:ring-2 focus:ring-black/80' placeholder={`
                 Example: 
